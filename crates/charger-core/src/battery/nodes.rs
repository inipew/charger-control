...
pub const AC_ONLINE_NODE: &str =
    "/sys/class/power_supply/ac/online";

pub const BATTERY_STATUS_NODE: &str =
    "/sys/class/power_supply/battery/status";

pub const USB_TYPEC_MODE_NODE: &str =
    "/sys/class/power_supply/usb/typec_mode";

pub const USB_ONLINE_NODE: &str =
    "/sys/class/power_supply/usb/online";

pub const MAIN_CHARGING_NODE: &str =
